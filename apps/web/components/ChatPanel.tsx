...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  "en-IN": {
    ...
    low_confidence: "⚠️ I'm having a bit of trouble identifying the exact problem from this photo. Could you please describe what's wrong? (Include details like what happened and how urgent it is)",
  ...
  "hi-IN": {
    ...
    low_confidence: "⚠️ मैं इस फोटो से समस्या को पूरी तरह नहीं समझ पा रहा हूँ। क्या आप कृपया बता सकते हैं कि क्या समस्या है? (जैसे कि समस्या क्या है और यह कितनी जरूरी है)",
  ...
  "ta-IN": {
    ...
    low_confidence: "⚠️ இந்தப் புகைப்படத்திலிருந்து சிக்கலை என்னால் சரியாகப் புரிந்துகொள்ள முடியவில்லை. தயவுசெய்து என்ன நடந்தது என்று விளக்க முடியுமா? (விவரங்களுடன் பகிரவும்)",
  ...
  "te-IN": {
    ...
    low_confidence: "⚠️ ఈ ఫోటో నుండి సమస్యను నేను సరిగ్గా అర్థం చేసుకోలేకపోతున్నాను. దయచేసి ఏమి జరిగిందో వివరించగలరా? (వివరాలతో వివరించండి)",
  ...
  "kn-IN": {
    ...
    low_confidence: "⚠️ ಈ ಫೋಟೋದಿಂದ ಸಮಸ್ಯೆಯನ್ನು ನನಗೆ ಸರಿಯಾಗಿ ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ಆಗುತ್ತಿಲ್ಲ. ದಯವಿಟ್ಟು ಏನು ತಪ್ಪಾಗಿದೆ ಎಂದು ವಿವರಿಸುವಿರಾ? (ವಿವರಗಳೊಂದಿಗೆ ತಿಳಿಸಿ)",
  ...
  "ml-IN": {
    ...
    low_confidence: "⚠️ ഈ ഫോട്ടോയിൽ നിന്ന് പ്രശ്നം എനിക്ക് കൃത്യമായി മനസ്സിലാക്കാൻ കഴിയുന്നില്ല. ദയവായി കൂടുതൽ വിവരങ്ങൾ നൽകാമോ? (എന്താണ് സംഭവിച്ചതെന്ന് വിശദീകരിക്കുക)",
  ...
  "bn-IN": {
    ...
    low_confidence: "⚠️ এই ছবি থেকে সমস্যাটি আমি সঠিকভাবে বুঝতে পারছি না। অনুগ্রহ করে কী হয়েছে তা একটু বিশদে লিখবেন কি? (বিস্তারিত তথ্য দিন)",
  ...
  "mr-IN": {
    ...
    low_confidence: "⚠️ या फोटोवरून मला समस्या नीट समजून घेता येत नाहीये. कृपया काय झाले आहे ते सांगाल का? (तपशीलांसह वर्णन करा)",
  ...
  "gu-IN": {
    ...
    low_confidence: "⚠️ આ ફોટા પરથી મને સમસ્યા બરાબર સમજાઈ રહી નથી. કૃપા કરીને શું થયું છે તે જણાવશો? (વિગતો સાથે વર્ણન કરો)",
  ...
  "pa-IN": {
    ...
    low_confidence: "⚠️ ਮੈਂ ਇਸ ਫੋਟੋ ਤੋਂ ਸਮੱਸਿਆ ਨੂੰ ਠੀਕ ਤਰ੍ਹਾਂ ਨਹੀਂ ਸਮਝ ਪਾ ਰਿਹਾ ਹਾਂ। ਕੀ ਤੁਸੀਂ ਦੱਸ ਸਕਦੇ ਹੋ ਕਿ ਕੀ ਹੋਇਆ ਹੈ? (ਵੇਰਵਿਆਂ ਨਾਲ ਦੱਸੋ)",
